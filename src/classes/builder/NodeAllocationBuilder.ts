export class NodeAllocationBuilder {
     ...
     */
    public setIp(ip: string): NodeAllocationBuilder {
        this.ip = ip;
        return this;
    }
     ...
     */
    public addPort(port: number): NodeAllocationBuilder {
     ...
     */
    public addPorts(ports: Array<number>): NodeAllocationBuilder {
     ...
     * @argument ports Ports to bin on | Range: 1024 <= 65535
     */
    public addPortsByRange(portRange: string): NodeAllocationBuilder {
     ...
     */
    public setAlias(alias: string): NodeAllocationBuilder {
        this.alias = alias;
        return this;
    }
