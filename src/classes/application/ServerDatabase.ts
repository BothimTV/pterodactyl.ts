...
export class ServerDatabase {
    ...
    constructor(client: ApplicationClient, dbProperties: ServerDb) {
        this.client = client;
    ...
    */
    public async resetPassword(): Promise<void> {
      const endpoint = new URL(this.client.panel + "/api/application/servers/" + this.server + "/databases/" + this.id + "/reset-password");
    ...
    */
    public async delete(): Promise<void> {
      const endpoint = new URL(this.client.panel + "/api/application/servers/" + this.server + "/databases/" + this.id);
